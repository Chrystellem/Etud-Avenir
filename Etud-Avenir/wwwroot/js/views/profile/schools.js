...
var SavedSchoolPage = /** @class */ (function (_super) {
    __extends(SavedSchoolPage, _super);
    function SavedSchoolPage(props) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = this.setState;
                        _b = {};
                        return [4 /*yield*/, (0, curriculum_service_1.getFavoritesCurriculums)()];
                    case 1:
                        _a.apply(this, [(_b.curriculums = _c.sent(),
                                _b)]);
                        return [2 /*return*/];
                }
            });
